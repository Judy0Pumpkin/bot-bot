...
public class TakeInA extends SequentialCommandGroup {
  /** Creates a new TakeInA. */
  public TakeInA(Intake m_intake, Arm m_arm, Elevator m_Elevator) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    
    addCommands(new InstantCommand(()->m_arm.armOut(), m_arm));
